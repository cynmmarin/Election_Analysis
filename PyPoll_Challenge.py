...
with open(file_to_save, "w") as text_file:
    ...
    for county_name in county_votes:
        ...
        county_votes_percentages = ((float(votes) / float(total_votes)) * 100)
        # 6d: Print the county results to the terminal.
        county_results = (
            f"{county_name}: {county_votes_percentages:.1f}% ({votes:,})\n")
    ...
    text.file.write(largest_county_turnout_summary)
